<template>
    ...
    <div class="hidden xl:flex flex-col">
      ...
      <div class="flex">
        <div class="border-t border-black w-[120px] mt-[35px]"></div>
         <form @submit.prevent="createTrip" class="w-[712px] min-h-[500px] border border-black mt-8 rounded-[40px] flex flex-col justify-start items-center space-y-6 p-6">
          ...
          <div class="w-[600px] flex justify-between">
           ...
           <div class="w-[600px] flex items-start justify-between">
            ...
            <textarea v-model="trip.description"
                      ...
                      placeholder="Например: не курю, с собой домашние животные не разрешены и т.д."></textarea>
          </div>
  ...
  <form @submit.prevent="createTrip"
        class="w-full max-w-sm flex flex-col space-y-6">
    <!-- маршруты -->
    ...
    <div class="flex justify-between items-center">
      ...
      <select v-model="trip.seats"
              class="w-12 h-10 appearance-none border border-black
                     rounded-full text-center font-montserrat font-semibold
                     text-[16px]">
    ...
    <!-- allowBooking -->
    <div class="flex justify-between items-center">
      <p class="font-montserrat font-semibold text-[16px]">
        Могут ли попутчики<br />бронировать сразу?
      </p>
      <label class="relative inline-block w-16 h-8 cursor-pointer">
        <input v-model="trip.allowBooking"
               type="checkbox"
    ...
    <div class="flex justify-between items-center">
      <p class="font-montserrat font-semibold text-[16px]">
        Цена поездки? <br />(за одного)
      </p>
      <div class="flex items-center space-x-1">
        <input v-model="trip.pricePerPassenger"
               type="text"
               class="w-20 h-10 border border-black rounded-full
